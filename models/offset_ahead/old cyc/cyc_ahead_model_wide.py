...
x_train = train_dataset.drop(columns = ['oldGHI', 'GHI', 'Minute', 'Month', 'Hour', 'Year', 'DNI', 'DHI', 'Solar Zenith Angle', 'Day', 'DayOfYear'])
y_train_oldGHI = train_dataset[['oldGHI']]
y_train = train_dataset[['GHI']]
x_test = test_dataset.drop(columns = ['oldGHI', 'GHI', 'Minute',  'Month', 'Hour', 'Year', 'DNI', 'DHI', 'Solar Zenith Angle', 'Day', 'DayOfYear'])
