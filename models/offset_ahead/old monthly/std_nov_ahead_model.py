...
mask = (dataset['Year'] <= 2020) & ((dataset['Month'] == 9) | (dataset['Month'] == 10) | (dataset['Month'] == 11))
train_dataset = dataset[mask].copy()
mask = (dataset['Year'] == 2021) & (dataset['Month'] == 11)
...
nov_sample_1 = x_train[:72]
nov_expected_1 = y_train[:72]
nov_sample_2 = x_train[72:144]
nov_expected_2 = y_train[72:144]
nov_sample_3 = x_train[144:216]
nov_expected_3 = y_train[144:216]
nov_sample_4 = x_train[216:288]
nov_expected_4 = y_train[216:288]
nov_sample_5 = x_train[288:360]
nov_expected_5 = y_train[288:360]
nov_sample_6 = x_train[360:432]
nov_expected_6 = y_train[360:432]
nov_sample_7 = x_train[432:504]
nov_expected_7 = y_train[432:504]
nov_sample_8 = x_train[504:576]
nov_expected_8 = y_train[504:576]
nov_sample_9 = x_train[576:648]
nov_expected_9 = y_train[576:648]
nov_sample_10 = x_train[648:720]
nov_expected_10 = y_train[648:720]
training_sample_list = [nov_sample_1, nov_sample_2, nov_sample_3, nov_sample_4, nov_sample_5, nov_sample_6, nov_sample_7, nov_sample_8, nov_sample_9, nov_sample_10]
training_expected_list = [nov_expected_1, nov_expected_2, nov_expected_3, nov_expected_4, nov_expected_5, nov_expected_6, nov_expected_7, nov_expected_8, nov_expected_9, nov_expected_10]
...
try:
    if resume:
        state = torch.load("saves/nov_ahead_state")
...
run_num = 1
folder_path = f"results/model_results/ahead/nov_ahead_{offset}/run_"
...
if resume:
    ...
    if overwrite_save:
        torch.save(state, "saves/nov_ahead_state")
    else:
        save_id = 1
        while os.path.exists("saves/nov_ahead_state" + f"_{save_id}"):
            save_id += 1
        plt.savefig("saves/nov_ahead_state" + f"_{save_id}")
