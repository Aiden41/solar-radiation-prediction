...
verbose = False
utc_data = True
offset = 0 # number of hours ahead to predict
...
mask = (dataset['Year'] <= 2020) & ((dataset['Month'] == 8) | (dataset['Month'] == 9) | (dataset['Month'] == 10))
train_dataset = dataset[mask].copy()
mask = (dataset['Year'] == 2021) & (dataset['Month'] == 10)
...
oct_sample_1 = x_train[:72]
oct_expected_1 = y_train[:72]
oct_sample_2 = x_train[72:144]
oct_expected_2 = y_train[72:144]
oct_sample_3 = x_train[144:216]
oct_expected_3 = y_train[144:216]
oct_sample_4 = x_train[216:288]
oct_expected_4 = y_train[216:288]
oct_sample_5 = x_train[288:360]
oct_expected_5 = y_train[288:360]
oct_sample_6 = x_train[360:432]
oct_expected_6 = y_train[360:432]
oct_sample_7 = x_train[432:504]
oct_expected_7 = y_train[432:504]
oct_sample_8 = x_train[504:576]
oct_expected_8 = y_train[504:576]
oct_sample_9 = x_train[576:648]
oct_expected_9 = y_train[576:648]
oct_sample_10 = x_train[648:720]
oct_expected_10 = y_train[648:720]
training_sample_list = [oct_sample_1, oct_sample_2, oct_sample_3, oct_sample_4, oct_sample_5, oct_sample_6, oct_sample_7, oct_sample_8, oct_sample_9, oct_sample_10]
training_expected_list = [oct_expected_1, oct_expected_2, oct_expected_3, oct_expected_4, oct_expected_5, oct_expected_6, oct_expected_7, oct_expected_8, oct_expected_9, oct_expected_10]
...
try:
    if resume:
        state = torch.load("saves/oct_ahead_state")
...
run_num = 1
folder_path = f"results/model_results/ahead/oct_ahead_{offset}/run_"
...
if resume:
    ...
    if overwrite_save:
        torch.save(state, "saves/oct_ahead_state")
    else:
        save_id = 1
        while os.path.exists("saves/oct_ahead_state" + f"_{save_id}"):
            save_id += 1
        plt.savefig("saves/oct_ahead_state" + f"_{save_id}")
