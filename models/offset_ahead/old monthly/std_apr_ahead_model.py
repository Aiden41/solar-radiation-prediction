...
mask = (dataset['Year'] <= 2020) & ((dataset['Month'] == 2) | (dataset['Month'] == 3) | (dataset['Month'] == 4))
train_dataset = dataset[mask].copy()
mask = (dataset['Year'] == 2021) & (dataset['Month'] == 4)
...
apr_sample_1 = x_train[:72]
apr_expected_1 = y_train[:72]
apr_sample_2 = x_train[72:144]
apr_expected_2 = y_train[72:144]
apr_sample_3 = x_train[144:216]
apr_expected_3 = y_train[144:216]
apr_sample_4 = x_train[216:288]
apr_expected_4 = y_train[216:288]
apr_sample_5 = x_train[288:360]
apr_expected_5 = y_train[288:360]
apr_sample_6 = x_train[360:432]
apr_expected_6 = y_train[360:432]
apr_sample_7 = x_train[432:504]
apr_expected_7 = y_train[432:504]
apr_sample_8 = x_train[504:576]
apr_expected_8 = y_train[504:576]
apr_sample_9 = x_train[576:648]
apr_expected_9 = y_train[576:648]
apr_sample_10 = x_train[648:720]
apr_expected_10 = y_train[648:720]
training_sample_list = [apr_sample_1, apr_sample_2, apr_sample_3, apr_sample_4, apr_sample_5, apr_sample_6, apr_sample_7, apr_sample_8, apr_sample_9, apr_sample_10]
training_expected_list = [apr_expected_1, apr_expected_2, apr_expected_3, apr_expected_4, apr_expected_5, apr_expected_6, apr_expected_7, apr_expected_8, apr_expected_9, apr_expected_10]
...
try:
    if resume:
        state = torch.load("saves/apr_ahead_state")
...
run_num = 1
folder_path = f"results/model_results/ahead/apr_ahead_{offset}/run_"
...
if resume:
    ...
    if overwrite_save:
        torch.save(state, "saves/apr_ahead_state")
    else:
        save_id = 1
        while os.path.exists("saves/apr_ahead_state" + f"_{save_id}"):
            save_id += 1
        plt.savefig("saves/apr_ahead_state" + f"_{save_id}")
