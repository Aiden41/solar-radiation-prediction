...
mask = (dataset['Year'] <= 2020) & ((dataset['Month'] == 3) | (dataset['Month'] == 4) | (dataset['Month'] == 5))
train_dataset = dataset[mask].copy()
mask = (dataset['Year'] == 2021) & (dataset['Month'] == 5)
...
may_sample_1 = x_train[:72]
may_expected_1 = y_train[:72]
may_sample_2 = x_train[72:144]
may_expected_2 = y_train[72:144]
may_sample_3 = x_train[144:216]
may_expected_3 = y_train[144:216]
may_sample_4 = x_train[216:288]
may_expected_4 = y_train[216:288]
may_sample_5 = x_train[288:360]
may_expected_5 = y_train[288:360]
may_sample_6 = x_train[360:432]
may_expected_6 = y_train[360:432]
may_sample_7 = x_train[432:504]
may_expected_7 = y_train[432:504]
may_sample_8 = x_train[504:576]
may_expected_8 = y_train[504:576]
may_sample_9 = x_train[576:648]
may_expected_9 = y_train[576:648]
may_sample_10 = x_train[648:720]
may_expected_10 = y_train[648:720]
training_sample_list = [may_sample_1, may_sample_2, may_sample_3, may_sample_4, may_sample_5, may_sample_6, may_sample_7, may_sample_8, may_sample_9, may_sample_10]
training_expected_list = [may_expected_1, may_expected_2, may_expected_3, may_expected_4, may_expected_5, may_expected_6, may_expected_7, may_expected_8, may_expected_9, may_expected_10]
...
try:
    if resume:
        state = torch.load("saves/may_ahead_state")
...
run_num = 1
folder_path = f"results/model_results/ahead/may_ahead_{offset}/run_"
...
if resume:
    ...
    if overwrite_save:
        torch.save(state, "saves/may_ahead_state")
    else:
        save_id = 1
        while os.path.exists("saves/may_ahead_state" + f"_{save_id}"):
            save_id += 1
        plt.savefig("saves/may_ahead_state" + f"_{save_id}")
