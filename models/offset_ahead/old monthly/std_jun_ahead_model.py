...
mask = (dataset['Year'] <= 2020) & ((dataset['Month'] == 4) | (dataset['Month'] == 5) | (dataset['Month'] == 6))
train_dataset = dataset[mask].copy()
mask = (dataset['Year'] == 2021) & (dataset['Month'] == 6)
...
jun_sample_1 = x_train[:72]
jun_expected_1 = y_train[:72]
jun_sample_2 = x_train[72:144]
jun_expected_2 = y_train[72:144]
jun_sample_3 = x_train[144:216]
jun_expected_3 = y_train[144:216]
jun_sample_4 = x_train[216:288]
jun_expected_4 = y_train[216:288]
jun_sample_5 = x_train[288:360]
jun_expected_5 = y_train[288:360]
jun_sample_6 = x_train[360:432]
jun_expected_6 = y_train[360:432]
jun_sample_7 = x_train[432:504]
jun_expected_7 = y_train[432:504]
jun_sample_8 = x_train[504:576]
jun_expected_8 = y_train[504:576]
jun_sample_9 = x_train[576:648]
jun_expected_9 = y_train[576:648]
jun_sample_10 = x_train[648:720]
jun_expected_10 = y_train[648:720]
training_sample_list = [jun_sample_1, jun_sample_2, jun_sample_3, jun_sample_4, jun_sample_5, jun_sample_6, jun_sample_7, jun_sample_8, jun_sample_9, jun_sample_10]
training_expected_list = [jun_expected_1, jun_expected_2, jun_expected_3, jun_expected_4, jun_expected_5, jun_expected_6, jun_expected_7, jun_expected_8, jun_expected_9, jun_expected_10]
...
try:
    if resume:
        state = torch.load("saves/jun_ahead_state")
...
run_num = 1
folder_path = f"results/model_results/ahead/jun_ahead_{offset}/run_"
...
if resume:
    ...
    if overwrite_save:
        torch.save(state, "saves/jun_ahead_state")
    else:
        save_id = 1
        while os.path.exists("saves/jun_ahead_state" + f"_{save_id}"):
            save_id += 1
        plt.savefig("saves/jun_ahead_state" + f"_{save_id}")
