...
mask = (dataset['Year'] <= 2020) & ((dataset['Month'] == 5) | (dataset['Month'] == 6) | (dataset['Month'] == 7))
train_dataset = dataset[mask].copy()
mask = (dataset['Year'] == 2021) & (dataset['Month'] == 7)
...
jul_sample_1 = x_train[:72]
jul_expected_1 = y_train[:72]
jul_sample_2 = x_train[72:144]
jul_expected_2 = y_train[72:144]
jul_sample_3 = x_train[144:216]
jul_expected_3 = y_train[144:216]
jul_sample_4 = x_train[216:288]
jul_expected_4 = y_train[216:288]
jul_sample_5 = x_train[288:360]
jul_expected_5 = y_train[288:360]
jul_sample_6 = x_train[360:432]
jul_expected_6 = y_train[360:432]
jul_sample_7 = x_train[432:504]
jul_expected_7 = y_train[432:504]
jul_sample_8 = x_train[504:576]
jul_expected_8 = y_train[504:576]
jul_sample_9 = x_train[576:648]
jul_expected_9 = y_train[576:648]
jul_sample_10 = x_train[648:720]
jul_expected_10 = y_train[648:720]
training_sample_list = [jul_sample_1, jul_sample_2, jul_sample_3, jul_sample_4, jul_sample_5, jul_sample_6, jul_sample_7, jul_sample_8, jul_sample_9, jul_sample_10]
training_expected_list = [jul_expected_1, jul_expected_2, jul_expected_3, jul_expected_4, jul_expected_5, jul_expected_6, jul_expected_7, jul_expected_8, jul_expected_9, jul_expected_10]
...
try:
    if resume:
        state = torch.load("saves/jul_ahead_state")
...
run_num = 1
folder_path = f"results/model_results/ahead/jul_ahead_{offset}/run_"
...
if resume:
    ...
    if overwrite_save:
        torch.save(state, "saves/jul_ahead_state")
    else:
        save_id = 1
        while os.path.exists("saves/jul_ahead_state" + f"_{save_id}"):
            save_id += 1
        plt.savefig("saves/jul_ahead_state" + f"_{save_id}")
