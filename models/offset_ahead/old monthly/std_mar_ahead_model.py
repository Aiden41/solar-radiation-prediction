...
mask = (dataset['Year'] <= 2020) & ((dataset['Month'] == 1) | (dataset['Month'] == 2) | (dataset['Month'] == 3))
train_dataset = dataset[mask].copy()
mask = (dataset['Year'] == 2021) & (dataset['Month'] == 3)
...
mar_sample_1 = x_train[:72]
mar_expected_1 = y_train[:72]
mar_sample_2 = x_train[72:144]
mar_expected_2 = y_train[72:144]
mar_sample_3 = x_train[144:216]
mar_expected_3 = y_train[144:216]
mar_sample_4 = x_train[216:288]
mar_expected_4 = y_train[216:288]
mar_sample_5 = x_train[288:360]
mar_expected_5 = y_train[288:360]
mar_sample_6 = x_train[360:432]
mar_expected_6 = y_train[360:432]
mar_sample_7 = x_train[432:504]
mar_expected_7 = y_train[432:504]
mar_sample_8 = x_train[504:576]
mar_expected_8 = y_train[504:576]
mar_sample_9 = x_train[576:648]
mar_expected_9 = y_train[576:648]
mar_sample_10 = x_train[648:720]
mar_expected_10 = y_train[648:720]
training_sample_list = [mar_sample_1, mar_sample_2, mar_sample_3, mar_sample_4, mar_sample_5, mar_sample_6, mar_sample_7, mar_sample_8, mar_sample_9, mar_sample_10]
training_expected_list = [mar_expected_1, mar_expected_2, mar_expected_3, mar_expected_4, mar_expected_5, mar_expected_6, mar_expected_7, mar_expected_8, mar_expected_9, mar_expected_10]
...
try:
    if resume:
        state = torch.load("saves/mar_ahead_state")
...
run_num = 1
folder_path = f"results/model_results/ahead/mar_ahead_{offset}/run_"
...
if resume:
    ...
    if overwrite_save:
        torch.save(state, "saves/mar_ahead_state")
    else:
        save_id = 1
        while os.path.exists("saves/mar_ahead_state" + f"_{save_id}"):
            save_id += 1
        plt.savefig("saves/mar_ahead_state" + f"_{save_id}")
