...
mask = (dataset['Year'] <= 2020) & ((dataset['Month'] == 6) | (dataset['Month'] == 7) | (dataset['Month'] == 8))
train_dataset = dataset[mask].copy()
mask = (dataset['Year'] == 2021) & (dataset['Month'] == 8)
...
aug_sample_1 = x_train[:72]
aug_expected_1 = y_train[:72]
aug_sample_2 = x_train[72:144]
aug_expected_2 = y_train[72:144]
aug_sample_3 = x_train[144:216]
aug_expected_3 = y_train[144:216]
aug_sample_4 = x_train[216:288]
aug_expected_4 = y_train[216:288]
aug_sample_5 = x_train[288:360]
aug_expected_5 = y_train[288:360]
aug_sample_6 = x_train[360:432]
aug_expected_6 = y_train[360:432]
aug_sample_7 = x_train[432:504]
aug_expected_7 = y_train[432:504]
aug_sample_8 = x_train[504:576]
aug_expected_8 = y_train[504:576]
aug_sample_9 = x_train[576:648]
aug_expected_9 = y_train[576:648]
aug_sample_10 = x_train[648:720]
aug_expected_10 = y_train[648:720]
training_sample_list = [aug_sample_1, aug_sample_2, aug_sample_3, aug_sample_4, aug_sample_5, aug_sample_6, aug_sample_7, aug_sample_8, aug_sample_9, aug_sample_10]
training_expected_list = [aug_expected_1, aug_expected_2, aug_expected_3, aug_expected_4, aug_expected_5, aug_expected_6, aug_expected_7, aug_expected_8, aug_expected_9, aug_expected_10]
...
try:
    if resume:
        state = torch.load("saves/aug_ahead_state")
...
run_num = 1
folder_path = f"results/model_results/ahead/aug_ahead_{offset}/run_"
...
if resume:
    ...
    if overwrite_save:
        torch.save(state, "saves/aug_ahead_state")
    else:
        save_id = 1
        while os.path.exists("saves/aug_ahead_state" + f"_{save_id}"):
            save_id += 1
        plt.savefig("saves/aug_ahead_state" + f"_{save_id}")
