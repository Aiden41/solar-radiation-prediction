...
mask = (dataset['Year'] <= 2020) & ((dataset['Month'] == 7) | (dataset['Month'] == 8) | (dataset['Month'] == 9))
train_dataset = dataset[mask].copy()
mask = (dataset['Year'] == 2021) & (dataset['Month'] == 9)
...
sep_sample_1 = x_train[:72]
sep_expected_1 = y_train[:72]
sep_sample_2 = x_train[72:144]
sep_expected_2 = y_train[72:144]
sep_sample_3 = x_train[144:216]
sep_expected_3 = y_train[144:216]
sep_sample_4 = x_train[216:288]
sep_expected_4 = y_train[216:288]
sep_sample_5 = x_train[288:360]
sep_expected_5 = y_train[288:360]
sep_sample_6 = x_train[360:432]
sep_expected_6 = y_train[360:432]
sep_sample_7 = x_train[432:504]
sep_expected_7 = y_train[432:504]
sep_sample_8 = x_train[504:576]
sep_expected_8 = y_train[504:576]
sep_sample_9 = x_train[576:648]
sep_expected_9 = y_train[576:648]
sep_sample_10 = x_train[648:720]
sep_expected_10 = y_train[648:720]
training_sample_list = [sep_sample_1, sep_sample_2, sep_sample_3, sep_sample_4, sep_sample_5, sep_sample_6, sep_sample_7, sep_sample_8, sep_sample_9, sep_sample_10]
training_expected_list = [sep_expected_1, sep_expected_2, sep_expected_3, sep_expected_4, sep_expected_5, sep_expected_6, sep_expected_7, sep_expected_8, sep_expected_9, sep_expected_10]
...
try:
    if resume:
        state = torch.load("saves/sep_ahead_state")
...
run_num = 1
folder_path = f"results/model_results/ahead/sep_ahead_{offset}/run_"
...
if resume:
    ...
    if overwrite_save:
        torch.save(state, "saves/sep_ahead_state")
    else:
        save_id = 1
        while os.path.exists("saves/sep_ahead_state" + f"_{save_id}"):
            save_id += 1
        plt.savefig("saves/sep_ahead_state" + f"_{save_id}")
