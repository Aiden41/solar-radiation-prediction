...
mask = (dataset['Year'] <= 2020) & ((dataset['Month'] == 10) | (dataset['Month'] == 11) | (dataset['Month'] == 12))
train_dataset = dataset[mask].copy()
mask = (dataset['Year'] == 2021) & (dataset['Month'] == 12)
...
dec_sample_1 = x_train[:72]
dec_expected_1 = y_train[:72]
dec_sample_2 = x_train[72:144]
dec_expected_2 = y_train[72:144]
dec_sample_3 = x_train[144:216]
dec_expected_3 = y_train[144:216]
dec_sample_4 = x_train[216:288]
dec_expected_4 = y_train[216:288]
dec_sample_5 = x_train[288:360]
dec_expected_5 = y_train[288:360]
dec_sample_6 = x_train[360:432]
dec_expected_6 = y_train[360:432]
dec_sample_7 = x_train[432:504]
dec_expected_7 = y_train[432:504]
dec_sample_8 = x_train[504:576]
dec_expected_8 = y_train[504:576]
dec_sample_9 = x_train[576:648]
dec_expected_9 = y_train[576:648]
dec_sample_10 = x_train[648:720]
dec_expected_10 = y_train[648:720]
training_sample_list = [dec_sample_1, dec_sample_2, dec_sample_3, dec_sample_4, dec_sample_5, dec_sample_6, dec_sample_7, dec_sample_8, dec_sample_9, dec_sample_10]
training_expected_list = [dec_expected_1, dec_expected_2, dec_expected_3, dec_expected_4, dec_expected_5, dec_expected_6, dec_expected_7, dec_expected_8, dec_expected_9, dec_expected_10]
...
try:
    if resume:
        state = torch.load("saves/dec_ahead_state")
...
run_num = 1
folder_path = f"results/model_results/ahead/dec_ahead_{offset}/run_"
...
if resume:
    ...
    if overwrite_save:
        torch.save(state, "saves/dec_ahead_state")
    else:
        save_id = 1
        while os.path.exists("saves/dec_ahead_state" + f"_{save_id}"):
            save_id += 1
        plt.savefig("saves/dec_ahead_state" + f"_{save_id}")
