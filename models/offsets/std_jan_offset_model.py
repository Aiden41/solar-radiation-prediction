...
verbose = False
utc_data = True
offset = 24 # number of hours ahead to predict
...
mask = (dataset['Year'] <= 2020) & ((dataset['Month'] == 11) | (dataset['Month'] == 12) | (dataset['Month'] == 1))
train_dataset = dataset[mask].copy()
mask = (dataset['Year'] == 2021) & (dataset['Month'] == 1)
...
jan_sample_1 = x_train[:72]
jan_expected_1 = y_train[:72]
jan_sample_2 = x_train[72:144]
jan_expected_2 = y_train[72:144]
jan_sample_3 = x_train[144:216]
jan_expected_3 = y_train[144:216]
jan_sample_4 = x_train[216:288]
jan_expected_4 = y_train[216:288]
jan_sample_5 = x_train[288:360]
jan_expected_5 = y_train[288:360]
jan_sample_6 = x_train[360:432]
jan_expected_6 = y_train[360:432]
jan_sample_7 = x_train[432:504]
jan_expected_7 = y_train[432:504]
jan_sample_8 = x_train[504:576]
jan_expected_8 = y_train[504:576]
jan_sample_9 = x_train[576:648]
jan_expected_9 = y_train[576:648]
jan_sample_10 = x_train[648:720]
jan_expected_10 = y_train[648:720]
training_sample_list = [jan_sample_1, jan_sample_2, jan_sample_3, jan_sample_4, jan_sample_5, jan_sample_6, jan_sample_7, jan_sample_8, jan_sample_9, jan_sample_10]
training_expected_list = [jan_expected_1, jan_expected_2, jan_expected_3, jan_expected_4, jan_expected_5, jan_expected_6, jan_expected_7, jan_expected_8, jan_expected_9, jan_expected_10]
...
try:
    if resume:
        state = torch.load("saves/std_saved_state")
...
run_num = 1
folder_path = f"results/model_results/offsets/jan_offset_{offset}/run_"
...
if resume:
    ...
    if overwrite_save:
        torch.save(state, "saves/std_saved_state")
    else:
        save_id = 1
        while os.path.exists("saves/std_saved_state" + f"_{save_id}"):
            save_id += 1
        plt.savefig("saves/std_saved_state" + f"_{save_id}")
